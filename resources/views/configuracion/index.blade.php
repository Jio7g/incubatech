                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                ...
                                <button type="button" class="text-red-600 hover:text-red-900 delete-configuracion" data-configuracion-id="{{ $configuracion->id }}">
                                    Eliminar
                                </button>
                            </td>
                        </tr>
...
<script>
    ...
    let configuracionIdToDelete = null;

    // Abrir el modal al hacer clic en el botón "Eliminar"
    document.querySelectorAll('.delete-configuracion').forEach(button => {
        button.addEventListener('click', (e) => {
            configuracionIdToDelete = e.target.dataset.configuracionId;
            deleteForm.action = `{{ route('configuracion.destroy', ':id') }}`.replace(':id', configuracionIdToDelete);
